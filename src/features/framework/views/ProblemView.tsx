...
import { ProblemEntry, Step2Data, Step6Data } from '@shared/types';
import { TrashIcon, SparklesIcon, RobotIcon, GlobeIcon, LayoutIcon } from '@shared/ui/icons';
import { SectionHeader, Card, InputField, TextAreaField, FactorCard } from '@shared/ui/components';
import { AI_APPROACHES } from '@shared/config/constants';
import { calculateProblemScore, getVerdict } from '@shared/lib/utils';
...
export const ProblemView: React.FC<ProblemViewProps> = ({
    ...
    return (
        ...
        {tab === 'gtm' && (
            <GTMStrategy 
                gtmPlan={activeProblem.gtmPlan}
                onUpdateGTM={(value) => updateActiveProblem('gtmPlan', value)}
                onGenerateGTM={generateGTM}
                isGenerating={isGeneratingGTM}
            />
        )}
        </div>
    );
