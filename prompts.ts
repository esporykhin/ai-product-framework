 ...
 * Редактируйте эти константы, чтобы изменить поведение ИИ.
 */

export const PROMPTS = {
  // Генерация стратегического фокуса (Step 1)
  ...
  // Генерация GTM Плана (Step 4 - New)
  ...
  // Генерация общей стратегии (Strategy View)
  ...
  // Генерация вопросов валидации (Strategy View)
